...
public class VideoEnter extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (mediaControls == null) {
            mediaControls = new MediaController(VideoEnter.this);
        }
        ...
        progressDialog = new ProgressDialog(VideoEnter.this);
        // set a title for the progress bar
        progressDialog.setTitle("Minion Attack");
          ...
          mCompletionListener =  new MediaPlayer.OnCompletionListener() {
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        if (mCompletionListener != null) {
                            it =    new Intent(VideoEnter.this, MainActivity.class);
                            startService(it);
                        }
                    }
                };
